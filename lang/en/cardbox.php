...
$string['ai_explain'] = 'AI giải thích';
$string['ai_hint_tooltip'] = 'Nhận gợi ý từ AI mà không tiết lộ đáp án';
$string['ai_hint_image_tooltip'] = 'Nhận gợi ý hình ảnh từ AI mà không tiết lộ đáp án';
$string['ai_explain_tooltip'] = 'Nhờ AI giải thích tại sao đây là đáp án đúng';
$string['ai_loading'] = 'AI đang suy nghĩ...';
$string['ai_loading_image'] = 'AI đang tạo hình ảnh...';
$string['ai_error'] = 'AI hiện không khả dụng. Vui lòng thử lại sau.';
$string['ai_error_noprovider'] = 'Chưa có nhà cung cấp AI nào được cấu hình. Vui lòng liên hệ quản trị viên.';
...
$string['ai_cardgen_placeholder'] = 'VD: 食べる, màu sắc trong tiếng Nhật, gia đình...';
$string['ai_cardgen_btn'] = 'AI tạo thẻ';
$string['ai_cardgen_massdesc'] = 'Nhập từ hoặc chủ đề → AI tạo cặp câu hỏi–đáp án và lưu thẻ ngay vào bộ thẻ.';
$string['ai_cardgen_loading'] = 'Đang tạo thẻ...';
$string['ai_cardgen_saved'] = 'Đã tạo và lưu thẻ! Nhập từ tiếp theo.';
$string['ai_cardgen_success'] = 'Đã điền nội dung! Kiểm tra lại trước khi lưu.';
$string['ai_cardgen_error'] = 'Không thể tạo thẻ. Vui lòng thử lại.';
$string['ai_cardgen_empty'] = 'Vui lòng nhập từ hoặc chủ đề muốn tạo thẻ.';
$string['ai_cardgen_prompt'] = 'Bạn là trợ lý tạo thẻ flashcard học tiếng Nhật. Tạo 1 thẻ flashcard cho từ/chủ đề: "{$a}". Trả về đúng định dạng JSON sau, không có gì khác ngoài JSON: {"question":"câu hỏi bằng tiếng Việt yêu cầu người học nhập từ/cụm từ tiếng Nhật","answer":"từ/cụm từ tiếng Nhật kèm cách đọc romaji trong ngoặc đơn"}';
...
$string['ai_hint_prompt_personalized'] = 'Bạn là trợ lý học tập. Bối cảnh: {$a->history} Hãy đưa ra 1-2 câu gợi ý ngắn gọn, phù hợp với mức độ khó khăn của học sinh, giúp họ trả lời câu hỏi sau mà KHÔNG tiết lộ trực tiếp đáp án. Trả lời bằng tiếng Việt trước, sau đó dịch sang tiếng Nhật. Câu hỏi: {$a->question}';
$string['ai_hint_history_struggling'] = 'Học sinh đã thử thẻ này {$a} lần và vẫn đang ở hộp 1 (thẻ khó nhất). Họ đang gặp nhiều khó khăn — hãy đưa ra gợi ý chi tiết và dễ hiểu hơn bình thường.';
$string['ai_hint_history_retry'] = 'Học sinh đã thử thẻ này {$a} lần nhưng vẫn trả lời sai. Hãy đưa ra gợi ý nhẹ nhàng, khuyến khích và có thêm liên tưởng trực quan.';
